...
<footer :class="darkMode ? 'bg-dark-800 border-t border-white/10' : 'bg-gray-900 border-t border-gray-800'">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
                <div class="flex items-center gap-2 mb-5">
                    ...
                    <span
                        class="font-heading text-xl font-700 text-white"><?php esc_html_e( 'NEZER', 'nezer-motors' ); ?>
                        <span class="text-gold-500"><?php esc_html_e( 'MOTORS', 'nezer-motors' ); ?></span></span>
                </div>
                <p class="font-body text-sm text-white/50 leading-relaxed mb-5">
                    <?php esc_html_e( 'Nyeri\'s trusted vehicle service group. Two branches, one commitment: honest, expert car care.', 'nezer-motors' ); ?>
                </p>
                <div class="space-y-2">
                    <a href="mailto:info@nezermotors.com"
                        ...
                        <?php esc_html_e( 'info@nezermotors.com', 'nezer-motors' ); ?>
                    </a>
                    <a href="https://wa.me/254733204672" target="_blank" rel="noopener noreferrer"
                ...
                <div class="flex items-center gap-3 mt-6">
                    <a href="https://www.facebook.com/nezermotors" target="_blank" rel="noopener noreferrer"
                        ...
                        aria-label="<?php esc_attr_e( 'Visit our Facebook page', 'nezer-motors' ); ?>">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://www.instagram.com/shell_kingongo" target="_blank" rel="noopener noreferrer"
                        ...
                        aria-label="<?php esc_attr_e( 'Visit our Instagram page', 'nezer-motors' ); ?>">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path
            ...
            <div>
                <div class="flex items-center gap-2 mb-5">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/autocare-logo.png' ); ?>"
                        alt="<?php esc_attr_e( 'AutoCare Express', 'nezer-motors' ); ?>" class="h-8 w-auto"
                        onerror="this.style.display='none'">
                    <span
                        class="font-heading text-lg font-700 text-white"><?php esc_html_e( 'AutoCare Express', 'nezer-motors' ); ?></span>
                </div>
                <div class="space-y-3 mb-6">
                    <div class="flex items-start gap-2 text-white/60 text-sm font-body">
                        ...
                        <?php esc_html_e( 'Nyeri — Opposite King\'ong\'o Prison', 'nezer-motors' ); ?>
                    </div>
                    <div class="flex items-center gap-2 text-white/60 text-sm font-body">
                        ...
                        <a href="tel:+254733204672"
                            class="hover:text-blue-400 transition-colors"><?php esc_html_e( '0733 204 672', 'nezer-motors' ); ?></a>
                    </div>
                    <div class="flex items-center gap-2 text-white/60 text-sm font-body">
                        <svg class="w-4 h-4 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                            <path
                        ...
                        <?php esc_html_e( 'Mon – Sat, 8:00 AM – 5:00 PM', 'nezer-motors' ); ?>
                    </div>
                </div>
                <div class="space-y-1">
                    <p class="font-sub font-600 text-white/30 text-xs uppercase tracking-wider mb-2">
            ...
            <div>
                <div class="flex items-center gap-2 mb-5">
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/quikfix-logo.png' ); ?>"
                        alt="<?php esc_attr_e( 'QuikFix', 'nezer-motors' ); ?>" class="h-8 w-auto brightness-200"
                        onerror="this.style.display='none'">
                    <span
                        class="font-heading text-lg font-700 text-white"><?php esc_html_e( 'QuikFix', 'nezer-motors' ); ?></span>
                </div>
                <div class="space-y-3 mb-6">
                    <div class="flex items-start gap-2 text-white/60 text-sm font-body">
                        ...
                        <?php esc_html_e( 'Shell Station, King\'ong\'o, Nyeri-Nyahururu Junction', 'nezer-motors' ); ?>
                    </div>
                    <div class="flex items-center gap-2 text-white/60 text-sm font-body">
                        ...
                        <a href="tel:+254710104644"
                            class="hover:text-red-400 transition-colors"><?php esc_html_e( '0710 104 644', 'nezer-motors' ); ?></a>
                    </div>
                    <div class="flex items-center gap-2 text-white/60 text-sm font-body">
                        <svg class="w-4 h-4 text-red-400" fill="currentColor" viewBox="0 0 24 24">
                            <path
        ...
        <div class="mt-12 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="font-body text-white/30 text-sm">
                <?php esc_html_e( '© 2026 Nezer Motors. All rights reserved.', 'nezer-motors' ); ?></p>
            <div class="flex items-center gap-5">
                <a href="<?php echo esc_url( home_url( '/about/' ) ); ?>"
                    class="font-body text-white/30 text-sm hover:text-white/60 transition-colors"><?php esc_html_e( 'About', 'nezer-motors' ); ?></a>
                <a href="<?php echo esc_url( home_url( '/contact/' ) ); ?>"
                    class="font-body text-white/30 text-sm hover:text-white/60 transition-colors"><?php esc_html_e( 'Contact', 'nezer-motors' ); ?></a>
                <a href="<?php echo esc_url( home_url( '/sitemap.xml' ) ); ?>"
                    class="font-body text-white/30 text-sm hover:text-white/60 transition-colors"><?php esc_html_e( 'Sitemap', 'nezer-motors' ); ?></a>
            </div>
        </div>
    </div>
</footer>
...
<div x-data="scrollToTop" x-show="visible" x-transition
    ...
    <button @click="scrollTop()" class="relative group flex items-center justify-center w-14 h-14 
        ...
        aria-label="<?php esc_attr_e( 'Scroll to Top', 'nezer-motors' ); ?>">
    ...
    <div class="absolute -top-12 left-1/2 transform -translate-x-1/2 
        ...
        <?php esc_html_e( 'Back to top', 'nezer-motors' ); ?>
...
<div x-data="whatsappWidget()" class="fixed bottom-6 right-6 z-50">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="px-4 py-3 flex items-center gap-3" style="background:linear-gradient(135deg,#25d366,#128c7e)">
            ...
            <div>
                <p class="text-white font-sub font-700 text-sm"><?php esc_html_e( 'Nezer Motors', 'nezer-motors' ); ?>
                </p>
            ...
            <button @click="open = false" class="ml-auto text-white/60 hover:text-white transition-colors"
                aria-label="<?php esc_attr_e( 'Close WhatsApp widget', 'nezer-motors' ); ?>">
                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    <path
        ...
        <div class="p-4">
            <div class="rounded-xl p-3 mb-3 text-sm font-body text-white/80" style="background:rgba(255,255,255,0.08)">
                <?php esc_html_e( 'Hi! Welcome to Nezer Motors. How can we help you today?', 'nezer-motors' ); ?>
            </div>
            <textarea x-model="message" placeholder="<?php esc_attr_e( 'Type your message...', 'nezer-motors' ); ?>"
                rows="3"
    ...
    <button @click="open = !open"
        ...
        style="background:linear-gradient(135deg,#25d366,#128c7e)"
        aria-label="<?php esc_attr_e( 'Open WhatsApp chat', 'nezer-motors' ); ?>">
        <!-- Pulse ring -->
